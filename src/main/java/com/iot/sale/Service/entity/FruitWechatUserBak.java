...
@Table(name = "fruit_wechat_user_bak", pk = "id")
@ApiModel(value = "FruitWechatUserBak", description = "微信用户资料表")
public class FruitWechatUserBak implements Serializable {
	...
	@ApiModelProperty(value = "渠道id（scene_id)")
	@Column(name = "sceneid")
